 ...
 */
public class TimeWMSLayerManager
{
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected TimeWMSLayersPanel addTab(int position, String server)
        {
            // Add a server to the tabbed dialog.
            try
            {
                TimeWMSLayersPanel layersPanel = new TimeWMSLayersPanel(AppFrame.this.getWwd(), server, wmsPanelSize);
