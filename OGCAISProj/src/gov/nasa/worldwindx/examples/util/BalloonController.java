...
public class BalloonController extends MouseAdapter implements SelectListener
{
    ...
    {
        //X-PATCH Marjan
        //casting null to String because of overloaded constructor
        KMLBalloonStyle style = (KMLBalloonStyle) feature.getSubStyle(new KMLBalloonStyle((String)null), KMLConstants.NORMAL);
        //X-END
    ...
    protected Balloon createBalloon(KMLAbstractFeature feature)
    {
        //X-PATCH Marjan
        //casting null to String because of overloaded constructor
        KMLBalloonStyle balloonStyle = (KMLBalloonStyle) feature.getSubStyle(new KMLBalloonStyle((String)null),
            KMLConstants.NORMAL);
        //X-END
