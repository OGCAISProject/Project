 ...
 */
public class SelectableIconLayer extends AbstractLayer
{
    ...
    protected SelectableIconRenderer iconRenderer = new SelectableIconRenderer();
	...
	//X-START
	//Vito
	public SelectableIconLayer(SelectableIconRenderer renderer){
