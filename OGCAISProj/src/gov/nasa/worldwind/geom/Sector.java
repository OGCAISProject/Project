...
public class Sector implements Cacheable, Comparable<Sector>, Iterable<LatLon>
{
    ...
    //X-PATCH Marjan
    //added convenience methods that return corners
    public final LatLon getSouthWest()
    {
    	return new LatLon(minLatitude, minLongitude);
    }
    public final LatLon getSouthEast()
    {
    	return new LatLon(minLatitude, maxLongitude);
    }
    public final LatLon getNorthWest()
    {
    	return new LatLon(maxLatitude, minLongitude);
    }
    public final LatLon getNorthEast()
    {
    	return new LatLon(maxLatitude, maxLongitude);
    }
    //X-END
