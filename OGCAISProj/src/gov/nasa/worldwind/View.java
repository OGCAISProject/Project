...
public interface View extends WWObject, Restorable
{
    ...
    //X-START
	/**
     * Use alternative model-view matrix.
	 * Alternative model-view matrix is used when you don't want to change 
	 * rendered data LOD or visibility, because of change in eye position.
	 * 
	 * In order to change actual view position and rotation user still needs
	 * to call openGL method glLoadMatrix()!
     */
	public void useModelviewMatrixAlt(boolean enable);
	
	/**
     * Set alternative model-view matrix.
	 * Alternative model-view matrix is used when you don't want to change 
	 * rendered data LOD or visibility, because of change in eye position.
	 * 
	 * User needs to enable alt mode in order to use alternative matrix;
	 * 
	 * In order to change actual view position and rotation user still needs
	 * to call openGL method glLoadMatrix()!
     */
	public void setModelviewMatrixAlt(Matrix matrix, boolean effectFrustum);
	 ...
	 * to call openGL method glLoadMatrix()!
     */
	public Matrix getModelviewMatrixAlt();
	
    /**
     * Set the model-view matrix. The model-view matrix transforms model coordinates to eye coordinates.
     *
     * @param set current model-view matrix.
     */
	
	//allow different views to share modelview matrix;
