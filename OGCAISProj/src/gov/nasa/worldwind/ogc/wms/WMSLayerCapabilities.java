...
public class WMSLayerCapabilities extends AbstractXMLEventParser
{
        ...
        throws XMLStreamException
    {
        ...
        {
        	//added by jing li to add time info
        	String content = ctx.nextEvent().toString();
            ...
            if (parser != null)
            {
                ...
                {
                	WMSLayerDimension tmpdim =(WMSLayerDimension) o ;
                	if (!WWUtil.isEmpty(content))
                    	tmpdim.setDimension(content);
                    this.addDimension(tmpdim);
                }
